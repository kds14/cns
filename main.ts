...
function imp_wh_op_finish(state: GameState) {
	state.upgrades.wh_op = true;
...
function coi_pol_finish(state: GameState) {
...
function inv_pol_finish(state: GameState) {
...
function pop_pol_finish(state: GameState) {
	...
	let e = document.getElementById("stor-pol-sel") as HTMLSelectElement;
...
function while_pol_finish(state: GameState) {
...
function after_pol_finish(state: GameState) {
	...
	let e = document.getElementById("sort-pol-sel") as HTMLSelectElement;
